...
$i=0;
$listeActivites = TypeActivite::fetchListTypeActiviteFromDatabase();
?>
        ...
        <?php foreach ($listeActivites as $activite): ?>
            ...
            <div class="card" style="width: 300px; margin-top: 5px; margin-right: 10px; margin-bottom: 5px; height: 400px; border: 2px solid var(--bs-emphasis-color);">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary" onclick="window.location.href='/ERP/GestionBillets/Activite/FicheActivite.php?IDTypeActivite=<?php echo urlencode($activite->getIDTypeActivite()); ?>'" type="button" style="margin-top: 30px;background: RGB(54,123,34);">Voir détails</button>
                    <button class="btn btn-success" onclick="window.location.href='/ERP/GestionBillets/Activite/CreaneauActivite.php?IDTypeActivite=<?php echo urlencode($activite->getIDTypeActivite()); ?>'" type="button" style="margin-top: 30px;margin-left: 10px;">Ajouter</button>
                </div>
            </div>
        <?php endforeach; ?>   
    </div>
