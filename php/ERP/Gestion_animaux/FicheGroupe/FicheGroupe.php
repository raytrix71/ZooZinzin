...
<body class="text-center" style="background: rgb(217,217,217);">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6" style="margin-top: 4px;"><img style="border-radius: 25px;border: 2px solid var(--bs-emphasis-color);margin-bottom: 20px;margin-top: 20px;" width="250" height="150" src="/Image/espece/<?php echo $resultat->getNomEspece() ?>.jpg">
                <div style="background: var(--bs-body-bg);border: 2px solid var(--bs-emphasis-color);border-radius: 25px;">
                    ...
                    <h1 style="text-align: left;">Effectif:<?php echo " ".$resultat->getEffectifGroupe() ?></h1>
                    <h1 style="text-align: left;">Poids Total:<?php echo " ".$resultat->getPoidsTotalGroupe() ?></h1>
                </div>
            </div>
            <div class="col-md-6" style="margin-top: 4px;">
                <div style="background: var(--bs-body-bg);border-style: solid;border-color: var(--bs-emphasis-color);border-radius: 25px;margin-top: 5px;">
                    ...
                    <p><?php echo $resultat->getCommentaireGroupe() ?></p>
                    <hr>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="modal-1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <input type="hidden" name="idGroupe" value="<?php echo $resultat->getIDGroupe() ?>">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="post" action="/Fonction_PHP/Gestion_Animaux/UpdateCommentaireGroupe.php">
                    <input type="hidden" name="idGroupe" value="<?php echo $resultat->getIDGroupe() ?>">
                    <div class="modal-body"><input class="form-control" type="text" name="commentaire" placeholder="Commentaire" min="1" required="" value="<?php echo $resultat->getCommentaireGroupe() ?>"></div>
