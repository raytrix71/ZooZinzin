...
<?php foreach ($listeanimal as $animal): ?>
    <?php if($animal->getNomEspece() == $_GET['nomespece']):  ?>
        <div class="card d-table" style="margin-top: 4px;border: 2px solid var(--bs-emphasis-color);padding-right: 0px;margin-left: 15px;margin-right: 15px;margin-bottom: 15px;width: 300px;height: 400px;">
            <img class="card-img-top w-100 d-block" alt="Photography of Gray and Black Monkey" style="padding-bottom: 0px;padding-right: 0px;margin-bottom: 2px;border-radius: 20px;margin-top: 0px;" src="/Image/Espece/<?php echo $animal->getNomEspece() ?>.jpg">
