                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <h6 class="text-muted mb-2">Zone:<?php echo "$espece[NOMZONE]" ?>&nbsp;</h6><button class="btn btn-primary" type="button" style="--bs-primary: RGB(54,123,34);--bs-primary-rgb: 54,123,34;background: RGB(54,123,34);">Afficher liste animaux</button>
                            </div>
