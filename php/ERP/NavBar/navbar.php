...
<body>
    <nav class="navbar navbar-expand-md bg-body py-3" style="background: rgba(0, 125, 5, 1);">
        <div class="container"><button class="btn btn-primary" type="button" data-bs-target="#offcanvas-menu" data-bs-toggle="offcanvas">Menu</button><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
