        ...
        <div class="offcanvas-body d-flex flex-column justify-content-between pt-0" style="background: #D9D9D9;">
            <div>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    <li class="nav-item"><a class="nav-link active link-light d-lg-flex align-items-lg-center" href="#" aria-current="page" style="background: rgb(54,123,34);"><i class="material-icons me-2">dashboard</i> Tableau de bord</a></li>
            ...
            <div>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item"><a class="nav-link link-body-emphasis" href="#"><i class="icon ion-ios-medical me-2"></i>Soins</a></li>
                    <li class="nav-item"></li>
                    <li class="nav-item"></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                    ...
                    <li class="nav-item"><a class="nav-link link-body-emphasis" href="/ERP/GestionBillets/VenteBillet/ventebillet.php"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-grid me-2">
