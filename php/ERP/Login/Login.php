<?php 
session_start();
if(isset($_SESSION['logStatut']) && $_SESSION['logStatut'] == "loggedin"){
    header("Location: ../Dashboard/dashboard.php");
}
else{ $_SESSION['logStatut']='loggedout';

}
?>

<?php if($_SESSION['logStatut']=='loggedout'): ?>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card mb-5">
                                <div class="card-body d-flex flex-column align-items-center">
                                    ...
                                    <form class="text-center" action="../../Fonction_PHP/connERP.php" method="post">
